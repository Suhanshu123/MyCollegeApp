...
public class BlankFragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView=view.findViewById(R.id.dean_fragment_text_view);
        if(Build.VERSION.SDK_INT<Build.VERSION_CODES.N){
            textView.setText(Html.fromHtml("<p"+
                    "Designation: Associate Professor & Dean & Head<br/><br/>"+
                    "Qualification Area: Ph.D<br/><br/>"+
                    "Research Area: Solid State Physics<br/><br/>"+
                    "Email-id: dr.sunilpanwar@yahoo.co.in<br/><br/>"+
                    "Contact-Number: 9897048445<br/><br/>"+
                    "</p>"));
        }
